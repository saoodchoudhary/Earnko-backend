...
router.post('/link-from-url', auth, requireAnyRole(['affiliate', 'admin']), linkGenLimiter, async (req, res) => {
  try {
...
// BULK
router.post('/link-from-url/bulk', auth, requireAnyRole(['affiliate', 'admin']), linkGenLimiter, async (req, res) => {
  try {
